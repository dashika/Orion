...
router.post('/', function(req, res, next) {
    pool.getConnection(function (err, connection) {
        ...
        connection.beginTransaction(function (err) {
            ...
            connection.query('call submit_new_password(?,?,?);', [req.session.id_, req.session.token, req.body.new_password],/* '62', 'e2059de16fed1ff25eaf626a789432cd6f7108cd', 'poi567'],*/
                function (err, rows) {
                    if (err) {
